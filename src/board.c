...
#define SLEEP1_TIMEOUT_MS 1800000  // 30 minutes to sleep1 from active
#define SLEEP2_TIMEOUT_MS 3600000  // 60 minutes to sleep2 from sleep1
#define SLEEP3_TIMEOUT_MS 7200000  // 120 minutes to sleep3 from sleep2
